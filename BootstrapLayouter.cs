//------------------------------------------------------------------------------
// <copyright file="BootstrapLayouter.cs" company="AvoBright">
...
namespace AvoBright.BootstrapLayouter
{
    ...
    [Guid(BootstrapLayouterGuids.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class BootstrapLayouter : Package
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BootstrapLayouter"/> class.
        /// </summary>
        public BootstrapLayouter()
        {
        ...
        {
            BootstrapLayouterCommand.Initialize(this);
            base.Initialize();
        }
